...
bundle add redis devise name_of_person rack-mini-profiler flamegraph stackprof \
  memory_profiler active_model_serializers pundit bullet rack-attack

bundle add foreman rspec-rails pry rubocop rubocop-rails factory_bot_rails \
  capybara chromedriver-helper selenium-webdriver shoulda-matchers dotenv-rails \
  simplecov --group "development, test"
